...
export const L10N = {
  'FR': {
    ...
    about: {
      ...
      subtitle: 'CV en ligne',
      content: 'Ce projet Angular à été créé pour mettre en application mes connaissances et avoir un CV en ligne. ' +
        'Pour développer ce site, les technologies suivantes sont utilisées:',       
      additional: 'Les ressources suivantes sont aussi utilisées:',
      link_to_github: 'VOIR LE CODE SOURCE',
    },
    contact: {
      title: 'Informations',
      general: 'Générales',
      profiles: 'Autres Profils en ligne',
      phone: 'Télephone',
    ...
    cv_item: {
      ...
      button_view_attachment: 'VOIR LE DOCUMENT',
      now: 'now',
    },
    education: {
      title_languages: 'Technologies',
      title_certificates: 'Diplômes',
    ...
    overview: {
      title: 'Aperçu',
      subtitle_aboutme: 'À propos de moi',
      subtitle_interests: 'Hobbies et Interêts',
    },
    pdf: {
  ...
  'EN': {
    ...
    about: {
      ...
      subtitle: 'Online-CV',
      content: 'This Angular project was created to apply my knowledge and have an online CV, ' +
  ...
  'IT': {
    ...
    education: {
      ...
      language_fluent: 'fluentemente',
      language_advanced: 'avanzato',
      language_intermediate: 'intermedio',
      language_elementary: 'elementare',
      language_beginner: 'novizio',
    },
    experience: {
  ...
  'ES': { // Thanks to Pelayo García (https://github.com/oyale)
    ...
    education: {
      ...
      title_certificates: 'certificados',
      title_education: 'educación',
      language_native: 'idioma materno',
      language_fluent: 'fluido',
      language_advanced: 'avanzado',
      language_intermediate: 'intermedio',
      language_elementary: 'rudimentario',
      language_beginner: 'iniciador',
    },
    experience: {
    ...
    header: {
      ...
      menu_publications: 'Publicaciones',
      menu_projects: 'Proyectos',
      menu_volunteering: 'Voluntariado',
      menu_contact: 'Contacto',
      menu_about: 'About',
    },
    overview: {
      title: 'Inicio',
      subtitle_aboutme: 'Acerca de mi',
      subtitle_interests: 'Hobbies e Intereses',
    },
    pdf: {
      button_tooltip: 'Descarga CV en PDF',
      label_city: 'CIUDAD',
      label_email: 'E-Mail',
      continuing_next_page: 'Continúa en la siguiente página...',
    ...
    publications: {
      title_talks: 'Charlas',
      title_publications: 'Publicaciones',
    },
    volunteering: {
  ...
  'CA': { // Thanks to Pelayo García (https://github.com/oyale)
    ...
    education: {
      ...
      language_native: 'llengua materna',
      language_fluent: 'fluïda',
      language_advanced: 'avançat',
      language_intermediate: 'intermedi',
      language_elementary: 'elemental',
      language_beginner: 'principiant',
    },
    experience: {
